...
MODIFY COLUMN NOME VARCHAR(55) NOT NULL,
MODIFY COLUMN ENDERECO VARCHAR(200) NOT NULL,
MODIFY COLUMN CPF VARCHAR(14) UNIQUE NOT NULL CONSTRAINT chk_cpf CHECK (CPF REGEXP '[0-9]{3}.[0-9]{3}.[0-9]{3}-[0-9]{2}'), 
MODIFY COLUMN TELEFONE VARCHAR(15) NOT NULL CONSTRAINT chk_telefone CHECK (TELEFONE REGEXP '^\\([0-9]{2}\\) [0-9]{4}-[0-9]{4}$'), 
